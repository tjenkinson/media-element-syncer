          ...
          (function() {
            function MediaElementSyncer(source) {
              ...
              var _ref =
                ...
                refreshInterval =
                  _ref$refreshInterval === void 0 ? 200 : _ref$refreshInterval,
                _ref$correctionTime = _ref.correctionTime,
                correctionTime =
                  _ref$correctionTime === void 0 ? 500 : _ref$correctionTime,
                _ref$seekThreshold = _ref.seekThreshold,
                seekThreshold =
                  _ref$seekThreshold === void 0 ? 1000 : _ref$seekThreshold;
                ...
                value: function _update() {
                  ...
                  this._children.forEach(function(child) {
                    try {
                      ...
                      var diff = sourceTime - currentTime;
                      var rate = Math.max(
                        0,
                        ((diff + _this2._correctionTime) /
                          _this2._correctionTime) *
                          sourcePlaybackRate
                      );
                      ...
                      if (
                        sourcePaused ||
                        rate < 0 ||
                        Math.abs(diff) >= _this2._seekThreshold
                      ) {
